...
with mp_pose.Pose(min_detection_confidence=0.7, min_tracking_confidence=0.7) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            if smooth_elbow_angle > 165:
                stage = "up"
            elif smooth_elbow_angle < 80 and stage == "up":
            ...
            cv2.putText(image, f'Reps: {pushup_counter}', (10,30), 
        ...
        cv2.imshow('Pushup Analyzer', cv2.flip(image, 1))
